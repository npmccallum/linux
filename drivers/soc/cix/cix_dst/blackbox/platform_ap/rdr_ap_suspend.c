...
/* struct suspend_stats is private in newer kernels - use compatible local definition */
...
void ap_suspend_dump(u32 modid, u32 etype)
{
	...
	/* save suspend state - suspend_stats is static in newer kernels, skip for now */
